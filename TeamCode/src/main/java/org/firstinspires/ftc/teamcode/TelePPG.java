...
// (Requires AprilTag to be scanned first with A button)
        ...
        if (gamepad2.x && !lastGamepad2XState) {
            ...
            // If either individual is toggled, disable the "both" toggle.
    ...
    private void executeShootSequence() {
        ...
        // Note: gamepad2.a is also used as a transfer toggle in the main loop, but the shoot sequence logic overrides servo positions.
