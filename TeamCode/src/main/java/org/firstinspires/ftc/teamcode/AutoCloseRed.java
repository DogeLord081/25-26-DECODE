...
public class AutoCloseRed extends OpMode {
    ...
    private final Pose afterShootPose = new Pose(56.55750819672132, 60, Math.toRadians(180)).mirror();
    private final Pose intakeBallsPose = new Pose(25.55750819672132, 60, Math.toRadians(180)).mirror();
    private final Pose afterShootPose2 = new Pose(54.55750819672132, 37, Math.toRadians(180)).mirror();
    private final Pose intakeBallsPose2 = new Pose(24.55750819672132, 37, Math.toRadians(180)).mirror();
