...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp (name = "TeleGPP")
public class TELEGPP extends OpMode {
    ...
    // --- FIXED PATTERN FOR THIS FILE: GPP ---
    private char[] ballOrder = {'G', 'P', 'P'};
    ...
    public void init() {
        ...
        telemetry.addData("Status", "Initialized - MODE: GPP");
    }
    ...
    public void loop() {
        ...
        // ========== TELEMETRY ==========
        telemetry.addData("--- MODE: GPP ---", "Green-Purple-Purple");
        ...
        telemetry.addData("--- PATTERN ---", "GPP (Hardcoded)");
        telemetry.addData("Ball Order", "GPP");
