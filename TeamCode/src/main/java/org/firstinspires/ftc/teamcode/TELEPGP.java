...
@com.qualcomm.robotcore.eventloop.opmode.TeleOp (name = "TELE-PGP")
public class TELEPGP extends OpMode {
    ...
    // --- FIXED PATTERN FOR THIS FILE: PGP ---
    private char[] ballOrder = {'P', 'G', 'P'};
    ...
    public void init() {
        ...
        telemetry.addData("Status", "Initialized - MODE: PGP");
    }
    ...
    public void loop() {
        ...
        // ========== TELEMETRY ==========
        telemetry.addData("--- MODE: PGP ---", "Purple-Green-Purple");
        ...
        telemetry.addData("--- PATTERN ---", "PGP (Hardcoded)");
        telemetry.addData("Ball Order", "PGP");
